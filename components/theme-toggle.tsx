		...
		<DropdownMenu>
			<DropdownMenuTrigger asChild>
				<Button variant='outline'>
					<Sun className='size-5 rotate-0 block transition-all dark:-rotate-90 dark:hidden' />
					<Moon className='size-5 rotate-90 hidden transition-all dark:rotate-0 dark:block' />
					<span>Tema</span>
				</Button>
			</DropdownMenuTrigger>
